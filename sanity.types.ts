...
export type AllSanitySchemaTypes = SanityImagePaletteSwatch | SanityImagePalette | SanityImageDimensions | SanityFileAsset | Geopoint | Order | Category | Banner | Product | SanityImageCrop | SanityImageHotspot | SanityImageAsset | SanityAssetSourceData | SanityImageMetadata | Slug;
export declare const internalGroqTypeReferenceTo: unique symbol;
// Source: ./src/sanity/lib/banner/getBanner.tsx
...
// Source: ./src/sanity/lib/products/getAllCategory.ts
...
// Source: ./src/sanity/lib/products/getProducyByCategory.ts
...
declare module "@sanity/client" {
  interface SanityQueries {
    ...
    "\n        *[_type == \"product\" && name match $searchParam]": PRODUCT_SEARCH_QUERYResult;
  }
}
